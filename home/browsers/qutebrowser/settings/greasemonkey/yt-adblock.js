...
(function () {
  ...
  function nativeTouch() {
    ...
    const maxNum = 750;
    const randomNum =
      (Math.floor(Math.random() * (maxNum - minNum + 1)) + minNum) / 1000;
  ...
  function skipAd(mutationsList, observer) {
    let video =
      ...
      document.querySelector(`video`); //获取视频节点
    let skipButton =
      document.querySelector(`.ytp-ad-skip-button`) ||
      document.querySelector(`.ytp-ad-skip-button-modern`);
    let shortAdMsg = document.querySelector(
