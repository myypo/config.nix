...
lib.makeBrowser isMainBrowser "org.qutebrowser.qutebrowser.desktop" {
  ...
  xdg.configFile."qutebrowser/greasemonkey/yt-adblock.js".source = ./settings/greasemonkey/yt-adblock.js;
  xdg.configFile."qutebrowser/greasemonkey/yt-shorts-blocker.js".source = ./settings/greasemonkey/yt-shorts-blocker.js;
